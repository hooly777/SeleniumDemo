...
public class NoElectronicPage extends BaseTest {
	
	Webgenericutility webutility= new Webgenericutility();
	
	public NoElectronicPage(WebDriver driver) {
		this.driver = driver;
  ...
  public void SelectElectronic() throws IOException {
	  ...
	  String ElecElement1 =  driver.findElement(By.xpath("//ul[@class='top-menu notmobile']//a[contains(text(),'Electronics')]")).getText();
	  System.out.println("Selected Electronics "+ ElecElement1);	
	  ElecElement.click();
