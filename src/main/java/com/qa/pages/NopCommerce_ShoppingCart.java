...
public class NopCommerce_ShoppingCart {
	...
	{
		Webgenericutility.clickOn(updateCartbutton);
		
	}
	
	public void clickCheckOutBtn()
	{
		Webgenericutility.clickOn(checkoutButton);
	}
	public void closePopUp()
	{
		
		Webgenericutility.clickOn(closeTermspopup);
	...
	{	
		...
		Webgenericutility.clickOn(acceptCheckbox);
